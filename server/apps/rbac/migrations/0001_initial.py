# Generated by Django 3.0.5 on 2020-04-08 12:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='rbac.Permission', verbose_name='父')),
            ],
            options={
                'verbose_name': '功能权限表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('公司', '公司'), ('部门', '部门')], default='department', max_length=20, verbose_name='类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.CharField(blank=True, default='/media/default/avatar.png', max_length=1000, null=True)),
